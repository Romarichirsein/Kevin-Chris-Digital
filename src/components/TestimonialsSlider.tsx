...
export const TestimonialsSlider: React.FC<TestimonialsSliderProps> = ({ onExploreCourses }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
            De la création de contenu jusqu'aux encaissements réels en FCFA et USD : découvrez l'impact direct de la méthode FaceHOOK et de nos formations.
          </p>
        </div>
      ...
      {/* Main Slider Card with Revolving Blue Perimeter & Glowing Hover */}
      <div className="blue-perimeter-beam shadow-2xl shadow-blue-950/40">
        <div className="blue-perimeter-inner bg-white dark:bg-slate-900 p-6 sm:p-10 lg:p-12">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Right Column: Narrative Quote & Student Info */}
